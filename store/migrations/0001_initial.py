# Generated by Django 5.1.3 on 2024-11-06 01:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='store_users', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='store_users', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
